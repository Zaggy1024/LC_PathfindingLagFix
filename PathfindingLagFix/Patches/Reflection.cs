...
namespace PathfindingLagFix.Patches
{
    public static class Reflection
    {
        ...
        public static readonly MethodInfo m_EnemyAI_ChooseFarthestNodeFromPosition = typeof(EnemyAI).GetMethod(nameof(EnemyAI.ChooseFarthestNodeFromPosition), [ typeof(Vector3), typeof(bool), typeof(int), typeof(bool) ]);
